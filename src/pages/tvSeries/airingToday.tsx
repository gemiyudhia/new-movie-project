...
const AiringToday = () => {
const {airingTodaySeries, fetchAiringTodaySeries} = useSeriesStore()
  ...
  return (
    <section className="container mx-auto mt-32">
      <div className="px-6 mt-8">
        <h1 className="text-white font-bold text-3xl pb-5">Airing Today Series</h1>
      </div>
      <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">
        {airingTodaySeries.map((item) => (
          <div key={item.id}>
