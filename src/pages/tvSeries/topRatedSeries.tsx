...
const TopRatedSeries = () => {
  const { topRatedSeries, fetchTopRatedSeries } = useSeriesStore();
            ...
            <div key={item.id}>
              <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
                ...
                <div className="p-4 md:p-5">
                  ...
                  <Button onClick={() => handleOpenDetail(item)} className="rounded-lg bg-blue-500 mt-4 py-3 px-6 lg:py-2 lg:px-4 lg:text-sm text-white data-[hover]:bg-blue-700 data-[active]:bg-sky-700">
                    Show Detail
                  </Button>
                </div>
              </div>
